...
export default function PanData(props) {
  ...
  const updateValues = async () => {
    setSaving(true);
    await updateData(selected, "pan", status);
    fetchData();
    setSelected([]);
    setSaving(false);
  };
          ...
          >
            <TableBody>
              <TableRow>
                ...
                <TableCell>
                  <Typography fontWeight="bold">Aadhaar No</Typography>
                </TableCell>
                <TableCell>
                  <Typography fontWeight="bold">Name in Aadhar</Typography>
                </TableCell>
                <TableCell>
                  <Typography fontWeight="bold">Father's Name</Typography>
                </TableCell>
                <TableCell>
                  <Typography fontWeight="bold">Mother's Name</Typography>
                </TableCell>
                <TableCell>
              ...
              {(rowsPerPage > 0
                ...
                <TableRow key={row._id}>
                  ...
                  <TableCell>
                    {`${row.title}. ${row.a_firstName} ${row.a_middleName} ${row.a_lastName}`}
                  </TableCell>
                  <TableCell>{`${row.a_mobile_no}`}</TableCell>
                  <TableCell>{`${row.email_id}`}</TableCell>
                  <TableCell>{`${dateFormat(new Date(row.dob))}`}</TableCell>
                  <TableCell>{`${row.aadhar_no}`}</TableCell>
                  <TableCell>{`${row.aadhar_name}`}</TableCell>
                  <TableCell>{`${row.f_firstName} ${row.f_middleName} ${row.f_lastName}`}</TableCell>
                  <TableCell>{`${row.m_firstName} ${row.m_middleName} ${row.m_lastName}`}</TableCell>
